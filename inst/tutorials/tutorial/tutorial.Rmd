...
<div align=center>![](images/example_confusion matrix.png){width="100%"}</div>
...
<div align=center>![](images/example_heatmap.png){width="100%"}</div>
...
<div align=center>![](images/example_correlation matrix.png){width="100%"}</div>
...
<div align=center>![](images/example_cluster scatter plot.png){width="100%"}</div>
